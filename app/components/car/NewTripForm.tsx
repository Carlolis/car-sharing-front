...
interface NewTripFormProps {
  ...
  editingTrajet?: boolean
}

export const NewTripForm = ({ showForm, editingTrajet, setShowForm }: NewTripFormProps) => {
  {/* Formulaire */}
            ...
            <CardHeader>
              ...
              >
                ...
                <span className="text-base lg:text-xl">
                  {editingTrajet ? 'Modifier le trajet' : 'Enregistrer un nouveau trajet'}
                </span>
              </CardTitle>
            </CardHeader>
